...
impl MatchedArg {
    ...
    pub(crate) fn append_val(&mut self, val: AnyValue, raw_val: OsString) {
        ...
        self.raw_vals.last_mut().expect(INTERNAL_ERROR_MSG).push(raw_val);
    }
...
impl PartialEq for MatchedArg {
    fn eq(&self, other: &MatchedArg) -> bool {
        ...
        self_source == other_source && self_indices == other_indices
            && self_type_id == other_type_id && self_raw_vals == other_raw_vals
